...
extern {
	...
	fn SetBtnLT(UserIndex: UINT, Press: BOOL)->BOOL;
	fn SetBtnRT(UserIndex: UINT, Press: BOOL)->BOOL;
	fn SetBtnLB(UserIndex: UINT, Press: BOOL)->BOOL;
	fn SetBtnRB(UserIndex: UINT, Press: BOOL)->BOOL;
	fn SetBtnGD(UserIndex: UINT, Press: BOOL)->BOOL;
	fn SetTriggerL(UserIndex: UINT, Value: BYTE)->BOOL;
 	fn SetTriggerR(UserIndex: UINT, Value: BYTE)->BOOL;
	fn SetAxisX(UserIndex: UINT, Value: SHORT)->BOOL;
	fn SetAxisY(UserIndex: UINT, Value: SHORT)->BOOL;
	fn SetAxisRx(UserIndex: UINT, Value: SHORT)->BOOL;
	fn SetAxisRy(UserIndex: UINT, Value: SHORT)->BOOL;
